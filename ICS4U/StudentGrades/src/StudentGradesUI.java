...
public class StudentGradesUI extends javax.swing.JFrame {
    ...
    // create arraylist for their records
    ArrayList<String> data = new ArrayList<String>();  // 4 marks per student (15*4) == 60    
    ...
    private void listActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listActionPerformed
        ...
        {
            if (names.get (i) != null)
            records.setText ("Student: "+names.get(i)+"\nTest 1: "+data.get(i*4)+"\nTest 2: "+data.get((i*4)+1)+"\nTest 3: "+data.get((i*4)+2)+"\nTest 4: "+data.get((i*4)+3)+"\n");
        }
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
        ...
        for (int i = 0; i < names.size (); i++)
        {
          ...
          {
              names.remove (i);
              output.setText (names.get(i)+"'s records have been deleted.");
          }
